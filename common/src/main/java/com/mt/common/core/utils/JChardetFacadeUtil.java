...
public class JChardetFacadeUtil {
    ...
    public static class JChardetFacade extends AbstractCodepageDetector implements nsICharsetDetectionObserver {
        ...
        private Integer amountOfVerifiers = 0;
        ...
        public synchronized Charset detectCodepage(InputStream in, Integer length) throws IOException {
            this.Reset();
            Integer read = 0;
            boolean done = false;
    ...
    interface ICodepageDetector extends Serializable, Comparable {
        ...
        Charset detectCodepage(InputStream var1, Integer var2) throws IOException;
    }
    ...
    public static class nsDetector extends nsPSMDetector implements nsICharsetDetector {
        ...
        public boolean DoIt(byte[] var1, Integer var2, boolean var3) {
            if (var1 != null && !var3) {
        ...
        public boolean isAscii(byte[] var1, Integer var2) {
    ...
    public static abstract class nsPSMDetector {
        ...
        public static final Integer JAPANESE = 1;
        public static final Integer CHINESE = 2;
        public static final Integer SIMPLIFIED_CHINESE = 3;
        public static final Integer TRADITIONAL_CHINESE = 4;
        public static final Integer KOREAN = 5;
        public static final Integer NO_OF_LANGUAGES = 6;
        public static final Integer MAX_VERIFIERS = 16;
        ...
        public boolean HandleData(byte[] var1, Integer var2) {
            for (int var3 = 0; var3 < var2; ++var3) {
                byte var5 = var1[var3];
                Integer var4 = 0;
        ...
        public void Sample(byte[] var1, Integer var2) {
            this.Sample(var1, var2, false);
        }

        public void Sample(byte[] var1, Integer var2, boolean var3) {
            Integer var4 = 0;
            Integer var6 = 0;
    ...
    public static interface nsICharsetDetector {
        ...
        boolean DoIt(byte[] var1, Integer var2, boolean var3);
    ...
    public static abstract class nsVerifier {
        ...
        static final Integer eidxSft4bits = 3;
        static final Integer eSftMsk4bits = 7;
        static final Integer eBitSft4bits = 2;
        static final Integer eUnitMsk4bits = 15;
        ...
        public abstract Integer stFactor();
    ...
    public static class nsEUCSampler {
        ...
        boolean Sample(byte[] var1, Integer var2) {
            if (this.mState == 1) {
                return false;
            } else {
                Integer var3 = 0;
