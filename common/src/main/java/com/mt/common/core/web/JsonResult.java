...
public class JsonResult extends HashMap<String, Object> {
    ...
    private static final Long DEFAULT_OK_CODE = Constants.RESULT_OK_CODE;  // 默认成功码
    private static final Long DEFAULT_ERROR_CODE = Constants.RESULT_ERROR_CODE;  // 默认失败码
     ...
     * 返回成功
     */
    public static JsonResult ok(Long code, String message) {
     ...
     * 返回失败
     */
    public static JsonResult error(Long code, String message) {
